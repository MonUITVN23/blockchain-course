// Lecture 6 Content - Blockchain Applications
// This file will be loaded dynamically by the main index.html

// Add slides for Lecture 6
addSlide(`
...
addSlide(`
<div class="slide">
    <h2>Nội dung Lecture 6</h2>
    <div class="slide-content">
        <div class="center">
            <h3>Đang cập nhật...</h3>
            <p>Nội dung chi tiết cho Lecture 6 sẽ được bổ sung sau.</p>
            <p>Chủ đề: DeFi, NFTs, Supply Chain, và các ứng dụng thực tế</p>
        </div>
    </div>
</div>
`);
