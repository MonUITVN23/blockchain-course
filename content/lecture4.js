// Lecture 4 Content - Ethereum and Smart Contracts
...
<div class="slide active">
    <div class="slide-title-page">
        ...
        <div class="title-content">
            ...
            <h1>Ethereum và<br>Smart Contracts</h1>
...
addSlide(`
<div class="slide">
    <h2>Nội dung Lecture 4</h2>
    <div class="slide-content">
        <div class="center">
            <h3>Đang cập nhật...</h3>
            <p>Nội dung chi tiết cho Lecture 4 sẽ được bổ sung sau.</p>
            <p>Chủ đề: Ethereum, Smart Contracts, và Solidity</p>
        </div>
    </div>
</div>
`);
