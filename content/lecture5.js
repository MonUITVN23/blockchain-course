// Lecture 5 Content - Consensus Mechanisms
...
<div class="slide active">
    <div class="slide-title-page">
        ...
        <div class="title-content">
            ...
            <h1>Các Cơ chế<br>Đồng thuận</h1>
...
addSlide(`
<div class="slide">
    <h2>Nội dung Lecture 5</h2>
    <div class="slide-content">
        <div class="center">
            <h3>Đang cập nhật...</h3>
            <p>Nội dung chi tiết cho Lecture 5 sẽ được bổ sung sau.</p>
            <p>Chủ đề: Proof of Work, Proof of Stake, và các cơ chế đồng thuận khác</p>
        </div>
    </div>
</div>
`);
